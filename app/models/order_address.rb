class OrderAddress
  ...
  with_options presence: true do
    ...
    validates :telephone_number,
              format: { with: /\A[0-9]{10,11}\z/, message: 'Only half-width numeric values with 10 to 11 digits are allowed.' }
    validates :token
  end
  ...
  def save
    ...
    Address.create(postcode:, origin_region_id:, city:, street_address:,
