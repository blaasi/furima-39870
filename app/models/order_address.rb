class OrderAddress
  ...
  def save
    ...
    Addres.create(postcode: postcode, origin_region_id: origin_region_id, city: city, street_address: street_address, telephone_number: telephone_number, order_id: order.id)
  end
end